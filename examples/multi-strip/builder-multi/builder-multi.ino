...
void setup()
{
  ...
  g_strip1 = lw::buses::BusBuilder()
                 ...
                 .setProtocol(lw::protocols::Ws2812xProtocol(
                     kStrip1Len,
                     lw::protocols::Ws2812xProtocolSettings{
  ...
  while (true)
  {
    ...
    {
      p1[i] = lw::pixelFromRGB(
          static_cast<uint8_t>((i + frame) & 0xFF),
          static_cast<uint8_t>((2U * i + frame) & 0xFF),
          0);
    }
