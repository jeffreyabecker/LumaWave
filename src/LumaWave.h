...
using Ws2812x = lw::protocols::Ws2812x<lw::ChannelOrder::GRB, &lw::protocols::timing::Generic800, false>;
...
using Ws2811 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Ws2811, false>;

using Ws2813 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Ws2813, false>;

using Ws2813Rgbw = lw::protocols::Ws2812x<lw::ChannelOrder::GRBW, &lw::protocols::timing::Ws2813, false>;

// Ws2805 removed (RGBCW 5-channel chip, no longer supported)

using Sk6812 = lw::protocols::Ws2812x<lw::ChannelOrder::GRB, &lw::protocols::timing::Sk6812, false>;
using Sk6812White = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Sk6812, false>;
using Sk6813 = Sk6812;

using Lc8812 = lw::protocols::Ws2812x<lw::ChannelOrder::GRB, &lw::protocols::timing::Lc8812, false>;

using Tm1829 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Tm1829, true>;

using Tm1814 = lw::protocols::Tm1814;

using Tm1914 = lw::protocols::Tm1914;

using Ws2814 = lw::protocols::Ws2812x<lw::ChannelOrder::RGBW, &lw::protocols::timing::Ws2814, false>;
using Ws2814A = lw::protocols::Ws2812x<lw::ChannelOrder::WRGB, &lw::protocols::timing::Ws2814, false>;

using Ws2815 = Ws2812;

using Ws2816 = lw::protocols::Ws2812x<lw::ChannelOrder::GRB, &lw::protocols::timing::Ws2816, false>;

using Ws2818 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Generic800, false>;

using Apa106 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Apa106, false>;

using Tx1812 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Tx1812, false>;

using Gs1903 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Gs1903, false>;

using Tm1803 = lw::protocols::Ws2812x<lw::ChannelOrder::RGB, &lw::protocols::timing::Generic400, false>;
using Tm1804 = Tm1803;
using Tm1809 = Tm1803;
