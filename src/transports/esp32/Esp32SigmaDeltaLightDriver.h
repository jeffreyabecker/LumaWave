...
template <typename TColor> class Esp32SigmaDeltaLightDriver : public ILightDriver<TColor>
{
  ...
  private:
    ...
    template <typename TComponent> int8_t mapComponentToDensity(TComponent component) const
    {
...
#if LW_ESP32_USE_SDM_DRIVER
    std::array<sdm_channel_handle_t, LightDriverSettingsType::MaxChannels> _channels{nullptr, nullptr, nullptr, nullptr,
                                                                                     nullptr};
#endif
    bool _begun{false};
};
