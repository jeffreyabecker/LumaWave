...
namespace detail
{
  struct KelvinToRgbIntegerMathQ11
  {
    ...
    static constexpr uint8_t evaluateRed(uint16_t kelvin)
    {
      ...
      if (kelvin <= 9000)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(RedSegment0, normalizeKelvin(kelvin, 6601, 9000))));
      }

      if (kelvin <= 20000)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(RedSegment1, normalizeKelvin(kelvin, 9001, 20000))));
      }
    ...
    static constexpr uint8_t evaluateGreen(uint16_t kelvin)
    {
      if (kelvin <= 2200)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(GreenSegment0, normalizeKelvin(kelvin, 1200, 2200))));
      }

      if (kelvin <= 3600)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(GreenSegment1, normalizeKelvin(kelvin, 2201, 3600))));
      }

      if (kelvin <= 5200)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(GreenSegment2, normalizeKelvin(kelvin, 3601, 5200))));
      }

      if (kelvin <= 6600)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(GreenSegment3, normalizeKelvin(kelvin, 5201, 6600))));
      }

      if (kelvin <= 9000)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(GreenSegment4, normalizeKelvin(kelvin, 6601, 9000))));
      }

      if (kelvin <= 20000)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(GreenSegment5, normalizeKelvin(kelvin, 9001, 20000))));
      }

      return static_cast<uint8_t>(clampByte(evaluatePolynomial(GreenSegment6, normalizeKelvin(kelvin, 20001, 65000))));
    }
    ...
    static constexpr uint8_t evaluateBlue(uint16_t kelvin)
    {
      ...
      if (kelvin <= 2800)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(BlueSegment0, normalizeKelvin(kelvin, 1901, 2800))));
      }

      if (kelvin <= 4200)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(BlueSegment1, normalizeKelvin(kelvin, 2801, 4200))));
      }

      if (kelvin <= 5400)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(BlueSegment2, normalizeKelvin(kelvin, 4201, 5400))));
      }

      if (kelvin <= 6600)
      {
        return static_cast<uint8_t>(clampByte(evaluatePolynomial(BlueSegment3, normalizeKelvin(kelvin, 5401, 6600))));
      }
...
private:
  ...
  {
    return {{{255, 137, 14},  {255, 141, 24},  {255, 144, 34},  {255, 148, 42},  {255, 151, 51},  {255, 154, 59},  {255, 157, 66},  {255, 160, 73},  {255, 163, 80},  {255, 166, 86},  {255, 169, 92},
             {255, 172, 98},  {255, 174, 104}, {255, 177, 109}, {255, 179, 114}, {255, 182, 119}, {255, 184, 124}, {255, 187, 129}, {255, 189, 134}, {255, 191, 138}, {255, 193, 142}, {255, 195, 146},
             {255, 197, 150}, {255, 199, 154}, {255, 201, 158}, {255, 203, 162}, {255, 205, 165}, {255, 207, 169}, {255, 209, 172}, {255, 211, 175}, {255, 213, 179}, {255, 214, 182}, {255, 216, 185},
             {255, 218, 188}, {255, 220, 191}, {255, 221, 194}, {255, 223, 197}, {255, 224, 200}, {255, 226, 202}, {255, 227, 205}, {255, 229, 208}, {255, 230, 210}, {255, 232, 213}, {255, 233, 215},
             {255, 235, 218}, {255, 236, 220}, {255, 238, 222}, {255, 239, 225}, {255, 240, 227}, {255, 242, 229}, {255, 243, 231}, {255, 244, 234}, {255, 246, 236}, {255, 247, 238}, {255, 248, 240},
             {255, 249, 242}, {255, 250, 244}, {255, 252, 246}, {255, 253, 248}, {255, 254, 250}, {255, 255, 252}, {255, 250, 255}, {253, 248, 255}, {250, 246, 255}}};
  }
