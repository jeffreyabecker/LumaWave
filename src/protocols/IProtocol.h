...
struct ProtocolTypeImpl<TProtocol, std::void_t<typename TProtocol::SettingsType>> : std::true_type
{
};
...
static constexpr bool ProtocolMoveConstructible =
    ProtocolType<TProtocol> && std::is_move_constructible<TProtocol>::value;
...
template <typename TProtocol>
struct ProtocolExternalBufferRequiredImpl<TProtocol, std::void_t<decltype(TProtocol::RequiresExternalBuffer)>>
...
static constexpr bool ProtocolExternalBufferRequired =
    ProtocolType<TProtocol> && ProtocolExternalBufferRequiredImpl<TProtocol>::value;
...
template <typename TProtocol>
struct ProtocolRequiredBufferSizeComputableImpl<
    TProtocol, std::void_t<decltype(TProtocol::requiredBufferSize(
                   std::declval<PixelCount>(), std::declval<const typename TProtocol::SettingsType&>()))>>
    : std::integral_constant<bool, std::is_convertible<decltype(TProtocol::requiredBufferSize(
                                                           std::declval<PixelCount>(),
...
static constexpr bool ProtocolRequiredBufferSizeComputable =
    ProtocolType<TProtocol> && ProtocolRequiredBufferSizeComputableImpl<TProtocol>::value;

template <typename TProtocol>
static constexpr bool ProtocolPixelSettingsConstructible =
    ProtocolType<TProtocol> && ProtocolMoveConstructible<TProtocol> && ProtocolExternalBufferRequired<TProtocol> &&
    ProtocolRequiredBufferSizeComputable<TProtocol> && !std::is_same<typename TProtocol::SettingsType, void>::value &&
    std::is_move_constructible<typename TProtocol::SettingsType>::value &&
    std::is_constructible<TProtocol, uint16_t, typename TProtocol::SettingsType>::value;
